        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Ada pertanyaan, saran, atau ingin memesan dalam jumlah besar? Jangan ragu untuk menghubungi kami.
            </p>
          </div>
            ...
            <div className="animate-slide-in">
              <div className="bg-white p-6 rounded-lg shadow-md mb-8">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <Button 
                    type="submit"
                    className="w-full bg-kepal-yellow hover:bg-kepal-orange text-kepal-dark"
                  >
                    Kirim Pesan
                  </Button>
                </form>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h2 className="text-2xl font-semibold mb-6">Ikuti Kami</h2>
            ...
            <div className="animate-slide-in" style={{ animationDelay: "0.2s" }}>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Jl. Makanan Enak No. 123, Jakarta Selatan, DKI Jakarta 12345</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Senin - Minggu: 10.00 - 21.00 WIB</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d126920.29707148078!2d106.7588576674392!3d-6.2295538348241!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f3e945e34b9d%3A0x5371bf0fdad786a2!2sJakarta%20Selatan%2C%20Kota%20Jakarta%20Selatan%2C%20Daerah%20Khusus%20Ibukota%20Jakarta!5e0!3m2!1sid!2sid!4v1654515299105!5m2!1sid!2sid"
                    width="100%"
                    height="450"
                    style={{ border: 0 }}
                    allowFullScreen
